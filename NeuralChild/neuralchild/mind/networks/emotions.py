...
class EmotionsNetwork(NeuralNetwork):
    ...
    def clone_with_growth(self, growth_factor: float = 1.2, min_dim: int = 8) -> 'EmotionsNetwork':
        ...
        new_hidden_dim = max(min_dim * 2, int(self.emotion_processor[0].out_features * growth_factor))
        ...
        new_network.growth_history.append(NeuralGrowthRecord(
            ...
            old_shape=[self.input_dim, self.emotion_processor[0].out_features, self.output_dim],
        ...
        logger.info(
            ...
            f"({self.input_dim}, {self.emotion_processor[0].out_features}, {self.output_dim}) → "
